...
export default function ScheduleEditPage() {
    ...
    useEffect(() => {
        axios.get(`/Schedules/?id=${params.id}`).then(response => {
    ...
    const handleSubmit = event => {
        ...
        axios.post("/Schedules/edit", schedulePayload).then(response => {
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                <FormField type="text" attr="firstName" label="First name" defaultValue={schedule.firstName}/>
                <FormField type="text" attr="surname" label="Surname" defaultValue={schedule.surname}/>
                <FormField type="email" attr="email" label="Email address" defaultValue={schedule.email}/>
                <SpecialitiesFormField defaultValue={schedule.specialityId}/>
                <div className="flex">
